...
def main(args=None):
    ...
    print("| ---------- | ------------:| --------------:| ---------:|")
    print("| yacrd      |              |                |           |")
    print("| dascrubber | {} {} {:.2f} |                |           |".format(len(y_discard & d_discard), len(y_discard | d_discard),  len(y_discard & d_discard) / len(y_discard | d_discard)))
    print("| miniscrub  | {} {} {:.2f} | {} {} {:.2f} |           |".format(len(y_discard & m_discard), len(y_discard | m_discard), len(y_discard & m_discard) / len(y_discard | m_discard), len(m_discard & d_discard), len(m_discard | d_discard), len(m_discard & d_discard) / len(m_discard | d_discard)))

    print("\nsplited ")
    print("|            | yacrd         | dascrubber     | miniscrub |")
    print("| ---------- | -------------:| --------------:| ---------:|")
    print("| yacrd      |               |                |           |")
    print("| dascrubber | {} {} {:.2f}  |                |           |".format(len(y_splited & d_splited), len(y_splited | d_splited),  len(y_splited & d_splited) / len(y_splited | d_splited)))
    print("| miniscrub  | {} {} {:.2f} | {} {} {:.2f} |           |".format(len(y_splited & m_splited), len(y_splited | m_splited), len(y_splited & m_splited) / len(y_splited | m_splited), len(m_splited & d_splited), len(m_splited | d_splited), len(m_splited & d_splited) / len(m_splited | d_splited)))

    print("\ntrimmed ")
    print("|            | yacrd        | dascrubber     | miniscrub |")
    print("| ---------- | ------------:| --------------:| ---------:|")
    print("| yacrd      |              |                |           |")
    print("| dascrubber | {} {} {:.2f} |                |           |".format(len(y_trimmed & d_trimmed), len(y_trimmed | d_trimmed),  len(y_trimmed & d_trimmed) / len(y_trimmed | d_trimmed)))
    print("| miniscrub  | {} {} {:.2f} | {} {} {:.2f} |           |".format(len(y_trimmed & m_trimmed), len(y_trimmed | m_trimmed), len(y_trimmed & m_trimmed) / len(y_trimmed | m_trimmed), len(m_trimmed & d_trimmed), len(m_trimmed | d_trimmed), len(m_trimmed & d_trimmed) / len(m_trimmed | d_trimmed)))

    print("\nnmodified ")
    print("|            | yacrd        | dascrubber     | miniscrub |")
    print("| ---------- | ------------:| --------------:| ---------:|")
    print("| yacrd      |              |                |           |")
    print("| dascrubber | {} {} {:.2f} |                |           |".format(len(y_nmodified & d_nmodified), len(y_nmodified | d_nmodified),  len(y_nmodified & d_nmodified) / len(y_nmodified | d_nmodified)))
    print("| miniscrub  | {} {} {:.2f} | {} {} {:.2f} |           |".format(len(y_nmodified & m_nmodified), len(y_nmodified | m_nmodified), len(y_nmodified & m_nmodified) / len(y_nmodified | m_nmodified), len(m_nmodified & d_nmodified), len(m_nmodified | d_nmodified), len(m_nmodified & d_nmodified) / len(m_nmodified | d_nmodified)))
